...
describe 'Calendario de Feriados' do
  ...
  it 'test01: un dia de semana puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? un_sabado).to be_truthy
  end

  it 'test02: un dia de semana puede NO ser feriado' do
    un_miercoles = Date.new(2017, 5, 3)
    expect(calendario_de_feriados.holiday? un_miercoles).to be_falsey
  end
  ...
  it 'test03: mas de un dia de semana puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? un_sabado).to be_truthy
    expect(calendario_de_feriados.holiday? un_domingo).to be_truthy
  end
  ...
  it 'test04: un dia de mes puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? un_primero_de_mayo).to be_truthy
  end
  ...
  it 'test05: mas de un dia de mes puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? un_primero_de_mayo).to be_truthy
    expect(calendario_de_feriados.holiday? un_25_de_mayo).to be_truthy
  end

  it 'test06: un dia de mes puede NO ser feriado' do
    un_primero_de_mayo = Date.new(2017, 5, 1)
    expect(calendario_de_feriados.holiday? un_primero_de_mayo).to be_falsey
  end
  ...
  it 'test07: una fecha puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? cumpleaños_de_eze).to be_truthy
  end
  ...
  it 'test08: mas de una fecha puede ser feriado' do
    ...
    expect(calendario_de_feriados.holiday? cumpleaños_de_eze).to be_truthy
    expect(calendario_de_feriados.holiday? cumpleaños_de_feche).to be_truthy
  end

  it 'test09: una fecha puede NO ser feriado' do
    cumpleaños_de_eze = Date.new(2017, 10, 16)
    expect(calendario_de_feriados.holiday? cumpleaños_de_eze).to be_falsey
  end
  ...
  it 'test11: un dia de la semana feriado en un periodo puede ser NO feriado fuera de ese periodo de tiempo' do
    ...
    expect(calendario_de_feriados.holiday? un_sabado_fuera_del_periodo).to be_falsey
  end
  ...
  it 'test13: un dia de mes feriado en un periodo puede ser NO feriado fuera de ese periodo de tiempo' do
    ...
    calendario_de_feriados.add_rule(HolidayRuleWithPeriodOfTime.new(
        HolidayRuleDayOfMonth.new(10, 16), periodo))
    expect(calendario_de_feriados.holiday? un_cumpleaños_de_eze_fuera_del_periodo).to be_falsey
  end
